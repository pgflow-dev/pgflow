...
const RUNTIME_SMOKE_MJS = [
  ...
  '}',
  '',
  'function expectAbsent(label, object, key) {',
  "  if (key in object) failures.push('Unexpected export: ' + label);",
  '}',
  '',
  ...
  "expectAbsent('ControlPlane', edgeWorker, 'ControlPlane');",
  '',
  '// Removed DSL compiler exports',
  "expectAbsent('compileFlow', dsl, 'compileFlow');",
  "expectAbsent('compareFlowShapes', dsl, 'compareFlowShapes');",
  '',
