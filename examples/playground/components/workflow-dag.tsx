...
import { StepStateRow, StepTaskRow } from '@/lib/db';

interface WorkflowDagProps {
  className?: string;
  stepStates?: StepStateRow[];
  stepTasks: StepTaskRow[];
}
...
export default function WorkflowDag({
  ...
  const getNodeColors = (stepSlug: string) => {
    ...
    const task = stepTasks.find((t) => t.step_slug === stepSlug);
      ...
      >
        ...
        <g className={`node website ${websiteColors.animationClass}`}>
          <rect
            ...
            height="30"
            rx="6"
            className={`${websiteColors.fill} ${websiteColors.stroke}`}
            strokeWidth="2"
          />
          <text
            x="100"
        ...
        <g className={`node sentiment ${sentimentColors.animationClass}`}>
          <rect
            ...
            height="30"
            rx="6"
            className={`${sentimentColors.fill} ${sentimentColors.stroke}`}
            strokeWidth="2"
          />
          <text
            x="300"
          ...
          {getNodeStatusIcon('sentiment', 350, 25)}
        </g>
        ...
        <g className={`node tags ${tagsColors.animationClass}`}>
          <rect
            ...
            height="30"
            rx="6"
            className={`${tagsColors.fill} ${tagsColors.stroke}`}
            strokeWidth="2"
          />
          <text
            x="300"
        ...
        <g className={`node summary ${summaryColors.animationClass}`}>
          <rect
            ...
            height="30"
            rx="6"
            className={`${summaryColors.fill} ${summaryColors.stroke}`}
            strokeWidth="2"
          />
          <text
            x="300"
          ...
          {getNodeStatusIcon('summary', 350, 105)}
        </g>
        ...
        <g className={`node saveToDb ${saveToDbColors.animationClass}`}>
          <rect
            ...
            height="30"
            rx="6"
            className={`${saveToDbColors.fill} ${saveToDbColors.stroke}`}
            strokeWidth="2"
          />
          <text
            x="500"
        ...
        {/* Website -> Sentiment */}
        <path
          d="M160 55 Q200 55 220 25 Q240 25 240 25"
          fill="none"
          className={getEdgeColor('website')}
          strokeWidth="2"
        />
        {/* Website -> Tags */}
        <path
          d="M160 65 Q200 65 220 65 Q240 65 240 65"
          fill="none"
          className={getEdgeColor('website')}
          strokeWidth="2"
        />
        {/* Website -> Summary */}
        <path
          d="M160 75 Q200 75 220 105 Q240 105 240 105"
          fill="none"
          className={getEdgeColor('website')}
          strokeWidth="2"
        />
        ...
        <path
          d="M360 25 Q380 25 400 40 Q420 55 440 65"
          fill="none"
          className={getEdgeColor('sentiment')}
          strokeWidth="2"
        />
        {/* Tags -> Save to DB */}
        <path
          d="M360 65 H440"
          fill="none"
          className={getEdgeColor('tags')}
          strokeWidth="2"
        />
        {/* Summary -> Save to DB */}
        <path
          d="M360 105 Q380 105 400 90 Q420 75 440 65"
          fill="none"
          className={getEdgeColor('summary')}
          strokeWidth="2"
        />
      </svg>
    </div>
