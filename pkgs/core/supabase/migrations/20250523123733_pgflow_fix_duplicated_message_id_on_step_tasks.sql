...
-- Create index "idx_step_tasks_flow_msg" to table: "step_tasks"
CREATE UNIQUE INDEX "idx_step_tasks_flow_msg" ON "pgflow"."step_tasks" ("flow_slug", "message_id") WHERE (message_id IS NOT NULL);
