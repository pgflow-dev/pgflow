...
BEGIN
  ...
  LOOP
    ...
    -- ==========================================
    -- Call cascade_skip_steps for each step with unmet condition and whenUnmet='skip-cascade'.
    -- Process in topological order; cascade_skip_steps is idempotent.
    PERFORM pgflow.cascade_skip_steps(cascade_resolve_conditions.run_id, ready_step.step_slug, 'condition_unmet')
    ...
    -- Check if run was failed during cascade (e.g., if cascade_skip_steps triggers fail)
