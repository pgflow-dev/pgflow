...
-- created by older releases keep their original listed spelling: drop_queue
-- addresses physical objects, so the drop resolves the spelling fresh
-- through pgmq.list_queues() (_listed_queue_name) and an ambiguous match is
