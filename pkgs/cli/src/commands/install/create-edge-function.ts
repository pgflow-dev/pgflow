...
const DENO_JSON_TEMPLATE = (version: string) => `{
  "imports": {
    "@pgflow/core": "jsr:@pgflow/core@${version}",
    "@pgflow/core/": "jsr:@pgflow/core/",
    "@pgflow/dsl": "jsr:@pgflow/dsl@${version}",
    "@pgflow/dsl/": "jsr:@pgflow/dsl/",
    "@pgflow/dsl/supabase": "jsr:@pgflow/dsl/supabase",
    "@pgflow/edge-worker": "jsr:@pgflow/edge-worker@${version}",
    "@pgflow/edge-worker/": "jsr:@pgflow/edge-worker/",
    "@pgflow/edge-worker/_internal": "jsr:@pgflow/edge-worker/_internal"
  }
}
`;
