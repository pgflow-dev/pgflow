...
template: splash
hero:
  tagline: Open Source background processing for your Supabase app
  image:
...
import _01_entrypoint from "./01_flow_entrypoint.raw.ts?raw";
import _02_parallel_processing from "./02_parallel_processing.raw.ts?raw";
import _03_combine from "./03_combine.raw.ts?raw";
import _05_trigger from "./05_trigger.raw.ts?raw";
...
6. Profit! You gain lot more with this simple approach:
