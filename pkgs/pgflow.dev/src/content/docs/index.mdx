...
hero:
  tagline: |
    Open Source background processing for your Supabase app.
    Define flows using statically typed TypeScript DSL
    and run on Edge Functions or dedicated workers.
