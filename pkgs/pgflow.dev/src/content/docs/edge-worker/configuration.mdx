...
EdgeWorker.start(handler, {
  maxConcurrent: 20, // how much jobs are processed at the same time
  maxPgConnections: 4, // how many connections to the databasee are opened
  maxPollSeconds: 5, // in-worker polling interval
  pollIntervalMs: 200, // in-database polling interval
  retryDelay: 5, // how long to wait before retrying a failed job
  retryLimit: 0, // how many times to retry a failed job
  visibilityTimeout: 3, // how long a job is invisible after reading
