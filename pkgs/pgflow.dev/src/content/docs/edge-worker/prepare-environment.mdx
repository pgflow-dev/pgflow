...
1. ### Setup Connection Pool
    ...
    in order to maximiza performance (learn more in [Connect to your database](https://supabase.com/docs/guides/database/connecting-to-postgres#more-about-connection-pooling) official docs).
