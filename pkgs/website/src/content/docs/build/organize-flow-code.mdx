...
The directory structure shown here is a **recommendation**, not a requirement. pgflow works with any file organization - what matters is that your flows are imported into your worker Edge Functions, where startup compilation deploys them and the handlers run. Feel free to adapt the structure to your project's needs.
:::
...
- **Clean imports**: `../../flows/index.ts` from worker functions, `../tasks/` from flows
