...
:::tip[API Reference]
For complete documentation of all context properties, see the [Context API Reference](/reference/apis/context/).
:::
...
See the [Context API Reference](/reference/apis/context/) for complete documentation of each property.
