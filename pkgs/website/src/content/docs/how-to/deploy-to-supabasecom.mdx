...
- pgflow installed and configured in your Supabase project
- Database connection string prepared (see [Prepare DB Connection String](/how-to/prepare-db-string/))
- `EDGE_WORKER_DB_URL` environment variable set to your pooled connection string (transaction mode)
