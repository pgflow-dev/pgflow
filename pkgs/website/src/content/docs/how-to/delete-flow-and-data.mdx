...
<Aside type="caution">
This function is not yet included in the default pgflow migrations as we're gathering feedback on optimal default configurations. It has been thoroughly unit tested, but you'll need to manually add it to your project as shown in the <a href="#the-delete-function">Delete Function</a> section below.
</Aside>
