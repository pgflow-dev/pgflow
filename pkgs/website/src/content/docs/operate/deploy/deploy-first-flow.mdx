...
If your password contains special characters (`@`, `&`, `:`, etc.), you'll need to URL-encode it. See [Connection String Encoding](/operate/maintain/connection-string/) for details.
</Aside>
...
[Follow the safety net setup guide →](/operate/deploy/keep-workers-running/)
...
Your first flow is now deployed and running in production!

When you need to update your flows:
- [Update Deployed Flows](/operate/deploy/update-deployed-flows/) - Learn the deprecation workflow for safe updates
- [Monitor Execution](/operate/observe/monitor-execution/) - Track flow runs and debug issues
- [Monitor Workers Health](/operate/observe/monitor-workers-health/) - Ensure workers stay healthy
