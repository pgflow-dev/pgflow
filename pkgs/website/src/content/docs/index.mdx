...
## How pgflow Makes Supabase More Powerful
...
Here's a 2-step workflow (**scrape a website**, then **analyze it with AI**) built both ways on Supabase:
...
<CardGrid>
  <Card title="🔒 Type safety across steps">
  ...
  <Card title="⚙️ Concurrency control">
