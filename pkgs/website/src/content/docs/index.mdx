...
hero:
  ...
  tagline: AI workflows you can actually debug.<br/>Build LLM chains, RAG pipelines, and AI workflows with zero external services.
  image:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: How It Works
      link: /concepts/architecture/how-pgflow-works/
      icon: information
      variant: minimal
editUrl: false
---
...
<div class="quickstart-caption">Sets up pgflow in your Supabase project. <a href="/get-started/installation/">View full setup guide →</a></div>
...
Everything runs within your Supabase project - no external orchestrators or infrastructure.
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="Install pgflow into your Supabase project in a few minutes"
  />
</CardGrid>
