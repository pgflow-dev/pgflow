...
<Aside type="note" title="Can I use pgflow in production?">
  Yes! pgflow is already running in production at several companies. The core engine is stable and battle-tested. As with any infrastructure component, we recommend testing your specific workflows thoroughly. <a href="https://www.pgflow.dev/discord/">Join our Discord</a> to connect with other production users.
</Aside>
