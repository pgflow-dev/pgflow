...
<CardGrid>
  <Card title="Too Much DIY Plumbing">
    Supabase already gives you pg_cron, pg_net, and queues. 
    pgflow enhances those primitives by providing a unified orchestration layer, saving you time and effort.
  </Card>

  <Card title="Limited Observability">
    Once tasks spread across multiple handlers, tracing progress gets hard and debugging often means chasing logs. pgflow centralizes that visibility.
  </Card>

  <Card title="No Type Safety Between Steps">
    pgflow introduces TypeScript-based workflow definitions that offer compile-time safety and reduce the mental overhead.
  </Card>

  <Card title="Reliance on External Services">
    By leveraging pgflow, you keep workflow state, dependencies, and execution within Supabase, reducing the need for additional services.
  </Card>
</CardGrid>
