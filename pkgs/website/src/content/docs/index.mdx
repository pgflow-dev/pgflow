...
<CardGrid>
  ...
  <Card title="Declarative Definitions" icon="approve-check">
...
- **AI Workflows:** Chain LLM calls, scrape sites, and process documents with reliable recovery from API failures
