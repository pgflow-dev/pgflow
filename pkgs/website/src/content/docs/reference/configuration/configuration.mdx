...
<Aside type="tip">
After deployment, you can update these settings without recompiling your flow. See [Tune Deployed Flows](/deploy/maintain/tune-flow-config/) for details.
</Aside>
...
<Aside type="note">
Worker configuration requires redeploying your Edge Function to change, while flow/step configuration can be updated on the fly with SQL queries. See [Tune Deployed Flows](/deploy/maintain/tune-flow-config/) for details on updating configuration without redeployment.
</Aside>
