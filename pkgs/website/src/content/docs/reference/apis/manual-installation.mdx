...
If your database password contains special characters (`@`, `&`, `:`, etc.), you must URL-encode them to avoid authentication errors. See our [DB Connection URLs](/operate/maintain/connection-string/) guide for detailed instructions.
:::
