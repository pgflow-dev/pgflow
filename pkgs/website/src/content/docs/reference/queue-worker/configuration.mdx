...
Your handler functions can access the resolved worker configuration through the context object. For detailed information about available configuration options and usage patterns, see [Context](/concepts/flows/context/).

## Next Steps

- [Update pgflow](/operate/maintain/update-pgflow/) - Keep your pgflow installation up to date with the latest features and bug fixes
