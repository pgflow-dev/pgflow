...
<Aside type="note">
For advanced use cases, you can use the [`compileFlow` function](/how-to/manually-compile-flow/) to manually generate SQL statements without creating migration files.
</Aside>
...
Once a flow is registered in the database, its structure cannot be modified. To change a flow, you can either [delete it](/how-to/delete-flow-and-data/) (development only) or use [versioning](/how-to/version-flows/).
