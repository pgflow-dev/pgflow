...
<CardGrid>
  <LinkCard title="Organize Flows Codebase" href="/how-to/organize-flows-codebase/" description="Learn how to structure your pgflow codebase for maintainability and reusability"/>
  ...
  <LinkCard title="Understand Flow DSL" href="/explanations/flow-dsl/" description="How pgflow's TypeScript DSL works to create type-safe, data-driven workflows"/>
</CardGrid>
