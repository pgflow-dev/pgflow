...
- Completed the [Create your first flow](/pgflow/getting-started/create-first-flow/) guide
...
4. ### Trigger your first flow
    ...
    Now let's start a flow run! Execute this SQL to start your workflow:
...
5. ### Monitor execution
    ...
    You can monitor the run status with this query:
...
6. ### View step states
    ...
    To see the status of individual steps, run:
    ...
    Replace the run_id with the one you received from starting the flow.
