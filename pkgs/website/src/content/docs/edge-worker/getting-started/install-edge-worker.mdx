---
title: Install Edge Worker for Supabase Background Processing
description: Step-by-step guide to set up Edge Worker on Supabase. Learn how to configure connection pooling, migrations, and environment for optimal background task processing and workflow automation.
sidebar:
  order: 1
---
...
## Getting Started with Supabase Background Processing

Edge Worker is designed to enhance your Supabase project with robust background processing capabilities. This guide will help you set up the necessary components for reliable task processing and workflow automation.
