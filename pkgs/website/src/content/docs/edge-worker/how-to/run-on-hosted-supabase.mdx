...
This guide explains the current process for deploying and maintaining workers in a hosted environment.

<NotProductionReady />

:::note
Running Edge Worker on hosted Supabase currently requires a few additional setup steps. Thanks to ongoing collaboration with the Supabase team, these requirements will be simplified in future releases.
:::
...
However, you need to pass Authorization header with your ANON key when calling hosted function.
