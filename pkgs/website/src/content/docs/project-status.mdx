...
During beta, breaking changes may be introduced for critical fixes or significant improvements. All changes are documented in [release notes](https://github.com/pgflow-dev/pgflow/releases) with migration guides. See [updating pgflow](/deploy/maintain/update-pgflow/) for the update process.
