...
Once a flow is registered in the database, its structure cannot be modified. To change a flow, you can either [delete it](/develop/delete-flows/) (development only) or use [versioning](/develop/version-flows/).
