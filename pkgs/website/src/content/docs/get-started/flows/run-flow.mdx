...
- Completed the [Create your first flow](/get-started/flows/create-flow/) guide
- Completed the [Edge Worker installation](/get-started/installation/)
</Aside>
...
<CardGrid>
  <LinkCard
    ...
    description="Understand how pgflow executes workflows behind the scenes"
  />
  <LinkCard
    title="Ship to Supabase"
    href="/operate/deploy/deploy-first-flow/"
    description="Deploy your workflows to production on Supabase's hosted platform"
  />
  <LinkCard
    title="Make flows resilient"
    href="/reference/configuration/configuration/#flow-options"
    description="Configure retry behavior, timeouts, and error handling for your workflows"
  />
  <LinkCard
    title="Observe runs with SQL"
    href="/operate/observe/monitor-execution/"
    description="Learn how to monitor and debug your workflow execution with SQL queries"
  />
</CardGrid>
