...
Workers access the database through the `EDGE_WORKER_DB_URL` environment variable. Set it using the connection string from the [previous step](/deploy/supabase/get-connection-string/):
