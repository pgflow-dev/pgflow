...
**Read this entire page carefully before using this function.** Incorrect usage can delete data before tasks have a chance to execute, especially when using [startDelay](/reference/configuration/configuration/#startdelay).
...
If you use [startDelay](/reference/configuration/configuration/#startdelay) on any steps, your retention period **MUST be longer** than your longest delay.
