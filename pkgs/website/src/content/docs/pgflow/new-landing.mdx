...
template: splash
hero:
  title: Run AI Agents & Jobs directly on Supabase
  tagline: pgflow adds deterministic, parallel workflow orchestration on top of Supabase Edge Functions and Queues.
  actions:
