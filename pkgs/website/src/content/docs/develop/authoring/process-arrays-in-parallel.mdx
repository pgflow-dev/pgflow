...
See [Map Steps](/concepts/flows/map-steps/) to understand how they work before diving into these patterns.
:::
...
When debugging map steps, use [`context.stepTask.task_index`](/reference/apis/context/#steptask) to identify which array element each task is processing.
:::
